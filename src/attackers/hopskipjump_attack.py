...
def main(args):
    ...
    try:
        ...
        print(f"--- HopSkipJump Attacker (Host Version) Started. Outputs: {args.output_dir}, Temp workdir: {workdir} ---")

        dist_log_path = os.path.join(args.output_dir, "hopskip_dist_log_host.csv")
        ...
        for i in range(args.iterations):
            ...
            dist_log_file.write(f"{i+1},{query_counter_ref[0]},{l2_dist:.6f},{linf_dist:.6f}\n")
            dist_log_file.flush()
